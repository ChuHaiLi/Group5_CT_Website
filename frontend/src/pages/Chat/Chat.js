...
export default function ChatPage() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const shouldAutoRename = (() => {
        const session =
          newlyCreatedSession || sessions.find((item) => item.id === sessionId);
  ...
  const handleRenameSession = async (event, session) => {
    event.stopPropagation();
    const currentTitle =
      (session.title || DEFAULT_SESSION_TITLE).trim() || DEFAULT_SESSION_TITLE;
      ...
      >
        ...
        <div className="bubble">
          <span className="label">
            {isUser ? displayName : "Travel Support AI"}
          </span>
          <p>{message.content}</p>
        </div>
        {isUser && (
          ...
          <div className="chat-layout">
            <aside className="chat-sidebar">
              ...
              <div className="session-list">
                {sessionsLoading && (
                  <p className="session-placeholder">Loading…</p>
                )}
                    ...
                    >
                      ...
                      <div className="session-meta">
                        ...
                        <div className="session-actions">
                          <button
                            onClick={(event) =>
                              handleRenameSession(event, session)
                            }
            ...
            <div className="chat-main">
              <div className="chat-window">
                <div className="chat-stream">
                  {messagesLoading && (
                    <div className="status-row">Loading conversation…</div>
                  )}
