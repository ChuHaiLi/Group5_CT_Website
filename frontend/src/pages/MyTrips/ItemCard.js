// ItemCard.jsx - FINAL: Portal fix giống ExplorePage pattern
        ...
        <Draggable draggableId={item.uniqueId} index={index}>
            {(provided, snapshot) => (
                <>
                    ...
                    {/* 🎯 PORTAL: Render modals outside ItemCard - giống ExplorePage */}
                    {showDeleteConfirm && ReactDOM.createPortal(
                        ...
                        >
                            ...
                            >
                                ...
                                <p>
                                    Bạn có chắc chắn muốn xóa <strong>"{item.name}"</strong> khỏi lịch trình?
                                </p>
                    ...
                    {showDestinationModal && ReactDOM.createPortal(
                        <DestinationModal
