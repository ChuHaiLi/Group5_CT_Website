...
// 🔑 IMPORT MỚI: Trang chỉnh sửa lịch trình
import TripEditPage from "./pages/MyTrips/TripEditPage"; 
...
function getDefaultContext(pathname) {
    ...
    if (pathname.startsWith("/trips/")) {
        return "Bạn đang xem hoặc chỉnh sửa chi tiết lịch trình chuyến đi.";
    }
    if (pathname === "/saved") {
